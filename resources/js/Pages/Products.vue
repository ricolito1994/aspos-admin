    ...
    <AppLayout :catchChangeBranch="catchChangeBranch">
        ...
        <div style="width:100%;">
            ...
            <div style="width:40%; float:left;">
                <input placeholder="PRODUCT NAME" type="text" style="width:100%;margin-left:1%;"/>
            </div>
            <div style="width:15%; padding-left:1%; float:left;">
                <PrimaryButton :additionalStyles="'padding:5%;'" @click="showProductModal">+ NEW PRODUCT</PrimaryButton>
            </div>
        </div>
        <br>
